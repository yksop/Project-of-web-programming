...
<head>
    ...
    <link rel="stylesheet" href="../css/invioConfermatoContatti.css">
...
<div class="container">
    ...
    <div class="confMessage">
        <h1 id="invio-confermato">Invio Confermato</h1>
        <p>Grazie per averci contattato!<br>Abbiamo ricevuto il tuo messaggio e ti contatteremo al pi&uacute; presto.</p>
    </div>
