...
<div id="formContainer" style="display: none">
  ...
  <div id="fast-way" style="display: none" >
    <div style="margin:15px; text-align: center;font-size: 20px; position: center; color: #ffa500;">Fast-way Login<br>Accedi istantaneamente alla tua pagina riservata!</div>
