package com.example.progetto_programmazione_web;
...
public class InvioEmail extends HttpServlet {
    ...
    public void invio(HttpServletRequest request, HttpServletResponse response) {
        ...
        oggetto = request.getParameter("Choice");
        messaggio = request.getParameter("Altre motivazioni");
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("../../webapp/JSP pages/invio_confermato.jsp");
