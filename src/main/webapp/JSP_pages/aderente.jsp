...
<head>
    ...
    <script src="../JavaScript/aderente.js"></script>

    <style>
        .sidebar {
            width: 25%;
            height: 100vh;
            background-image: url("../Immagini progetto/Private/11v.jpg");
...
<div class="content">
    ...
    <h1 style="position: center">Bentornato socio!</h1>
...
<div class="box">
        <div class="menu-button-cont">
            ...
            <button class="menu-button registration-button">Iscrizione alle attività</button>
    ...
    <div class="finestre">
        ...
        <div id="donation-data" class="content-container">
            <input type="number" id="donation-input" placeholder="Inserisci la cifra in euro">
            ...
            <div id="donation-message" style="display: none; text-align: center; margin-top: 20px; font-size: 40px; color: lightseagreen"></div>
        </div>
