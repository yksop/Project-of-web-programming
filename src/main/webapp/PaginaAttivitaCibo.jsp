    ...
    <div class="corpo-attivita">
      ...
      <div class="riga-corpo">
        <div class="immagine-corpo">
          <img src="Immagini progetto/cibo.jpg" alt="distribuzione cibo 1">
         </div>
      </div>
      <div class="riga-corpo">
        <div class="colonna-corpo">
      ...
      <div class="riga-corpo">
        <div class="immagine-corpo">
          <img src="Immagini progetto/cibo2.jpg" alt="distribuzione cibo 1">
         </div>
      </div>
      <div class="riga-corpo">
        <div class="colonna-corpo">
      ...
      <div class="riga-corpo">
        <div class="immagine-corpo">
          <img src="Immagini progetto/cibo3.jpg" alt="distribuzione cibo 1">
        </div>
      </div>
    </div>
