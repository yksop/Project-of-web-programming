...
<html>
  <head>
    ...
    <link rel="icon" href="Immagini progetto/Logo_Tum4World.png.jpg" type="image/icontype">
      ...
      <div class="riga-attivita">
        <div class="colonna-attivita">
          <p>
            ...
            Per saperne di più clicca <a href="PaginaAttivitaCibo.html">qui</a> oppure sull'immagine qui accanto.
          </p>
        </div>
        <div class="colonna-attivita">
          <a href="PaginaAttivitaCibo.html"><img src="Immagini progetto/cibo.jpg" alt="Cibo in beneficenza"></a>
        </div>
      </div>
      <h1>Alberi piantati</h1>
      <div class="riga-attivita">
        <div class="colonna-attivita">
          <a href="PaginaAttivitaAlberi.html"><img src="Immagini progetto/pianta1.jpg" alt="Foto volontariato"></a>
        </div>
        <div class="colonna-attivita">
          <p>
            ...
            Per saperne di più clicca <a href="PaginaAttivitaAlberi.html">qui</a> oppure sull'immagine qui accanto.          </p>
        </div>
      </div>
      ...
      <div class="riga-attivita">
        <div class="colonna-attivita">
          <p>
            ...
            Per saperne di più clicca <a href="PaginaAttivitaVolontariato.html">qui</a> oppure sull'immagine qui accanto.          
          </p>
        </div>
        <div class="colonna-attivita">
          <a href="PaginaAttivitaVolontariato.html"><img src="Immagini progetto/volontariato1.jpg" alt="Foto volontariato"></a>
        </div>
      </div>
    </div>
