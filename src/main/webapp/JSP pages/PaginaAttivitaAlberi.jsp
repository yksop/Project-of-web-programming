...
<html>
  ...
  <body>
    ...
    <div class="corpo-attivita">
      ...
      <div class="riga-corpo">
        <div class="colonna-corpo">
          <p>
            ...
            Attraverso il nostro impegno nel ripristino forestale e nella conservazione degli ecosistemi, miriamo a mitigare il cambiamento climatico e preservare la biodiversità, fornendo sostegno alle comunità locali.          </p>
        </div>
      </div>
      <div class="riga-corpo">
        <div class="immagine-corpo">
          <img src="../Immagini%20progetto/pianta1.jpg" alt="distribuzione cibo 1">
         </div>
      </div>
      <div class="riga-corpo">
        <div class="colonna-corpo">
      ...
      <div class="riga-corpo">
        <div class="immagine-corpo">
          <img src="../Immagini%20progetto/pianta2.jpg" alt="distribuzione cibo 1">
         </div>
      </div>
      <div class="riga-corpo">
        <div class="colonna-corpo">
      ...
      <div class="riga-corpo">
        <div class="immagine-corpo">
          <img src="../Immagini%20progetto/pianta3.jpg" alt="distribuzione cibo 1">
        </div>
      </div>
    </div>
